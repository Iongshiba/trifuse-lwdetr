    ...
    def __init__(
        ...
        if "vit" in name:
            if name == "vit_tiny":
                ...
                img_size, embed_dim, depth, num_heads, dp = 1024, 384, 12, 12, 0.0
            elif name == "vit_base":
                img_size, embed_dim, depth, num_heads, dp = 1024, 768, 12, 12, 0.0
            else:
                raise NotImplementedError(
                    "Backbone {} is not support now.".format(name)
                )
